# Vettvangur.IcelandAuth <sup>v2.0.0</sup>
...
A .Net 5 version will utilise the custom certificate store option to build a chain and will come bundled with the audkenni certificates... stay tuned :)
...
* .Net 5 sample with accompanying package utilising the custom certificate store functionality
